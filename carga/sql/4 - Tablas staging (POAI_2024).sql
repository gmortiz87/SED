...
-- stg_fuente_poai
-- ========================
DROP TABLE IF EXISTS stg_fuente_poai_2024;
CREATE TABLE stg_fuente_poai_2024 (
  `N°` INT,
...
-- ========================
DROP TABLE IF EXISTS stg_actividades_poai_2024;
CREATE TABLE stg_actividades_poai_2024 (
  `N°` INT,
...
-- ========================
DROP TABLE IF EXISTS stg_beneficiarios_poai_2024;
...
-- stg_metas_poai
-- ========================
DROP TABLE IF EXISTS stg_metas_poai_2024;
CREATE TABLE stg_metas_poai_2024 (
  `ID_Meta` INT,
  `Hoja` VARCHAR(100),
  `Nombre_Proyecto` VARCHAR(255),
