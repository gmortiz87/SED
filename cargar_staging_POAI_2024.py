...
archivos = {
    "stg_fuente_poai_2024": DEPURADO / "stg_fuente_poai_2024_depurado.xlsx",
    "stg_proyectos_poai_2024": DEPURADO / "stg_proyectos_poai_2024_depurado.xlsx",
    "stg_actividades_poai_2024": DEPURADO / "stg_actividades_poai_2024_depurado.xlsx",
    "stg_beneficiarios_poai_2024": DEPURADO / "stg_beneficiarios_poai_2024_depurado.xlsx",
    "stg_metas_poai_2024": DEPURADO / "stg_metas_poai_2024_depurado.xlsx",
}
...
def cargar_tabla(tabla, ruta_excel, engine):
    ...
    renombres = {
        "Apropiación Definitiva 2024": "Apropiación Definitiva",
        "Total Ejecutado 2024": "Total Ejecutado",
